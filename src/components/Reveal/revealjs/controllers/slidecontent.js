...
export default class SlideContent {
  ...
  load(slide, options = {}) {
    ...
    queryAll(slide, 'img[data-src], video[data-src], audio[data-src], iframe[data-src]').forEach(
      element => {
    ...
    if (background) {
      ...
      const backgroundIframeElement = backgroundContent.querySelector('iframe[data-src]')
